    ...
    axios
        ...
        .then((response) => {
            ...
            if (formGrafico.value.filtro == "todos") {
                graf1("container", "Pidió Ayuda a otra Persona o Autoridad", "total", xAxis, series);
            } else {
                xAxis = {
                ...
                graf2(
                    "container",
                    "Pidió Ayuda a otra Persona o Autoridad",
                    "total",
                    xAxis,
...
<template>
    <Head title="Pidió Ayuda a otra Persona o Autoridad"></Head>
    <v-container>

...
const getInfoAnalisis = () => {
    axios
        .get(route("no_ayuda_sinimportancia.grafico"), {
        ...
        .then((response) => {
            ...
            if (formGrafico.value.filtro == "todos") {
                graf1("container", "No Pidió Ayuda porque se trató de un hecho sin importancia", "total", xAxis, series);
            } else {
                xAxis = {
                ...
                graf2(
                    "container",
                    "No Pidió Ayuda porque se trató de un hecho sin importancia",
                    "total",
                    xAxis,
...
<template>
    <Head title="No Pidió Ayuda porque se trató de un hecho sin importancia"></Head>
    <v-container>

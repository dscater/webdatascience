...
const getInfoAnalisis = () => {
    axios
        .get(route("no_ayuda_nocreejusticia.grafico"), {
        ...
        .then((response) => {
            ...
            if (formGrafico.value.filtro == "todos") {
                graf1("container", "No Pidió Ayuda porque no Cree en la Justicia", "total", xAxis, series);
            } else {
                xAxis = {
                ...
                graf2(
                    "container",
                    "No Pidió Ayuda porque no Cree en la Justicia",
                    "total",
                    xAxis,
...
<template>
    <Head title="No Pidió Ayuda porque no Cree en la Justicia"></Head>
    <v-container>

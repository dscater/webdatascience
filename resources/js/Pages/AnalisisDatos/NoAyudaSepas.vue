...
const getInfoAnalisis = () => {
    axios
        .get(route("no_ayuda_sepa.grafico"), {
        ...
        .then((response) => {
            ...
            if (formGrafico.value.filtro == "todos") {
                graf1("container", "No Pidió Ayuda porque no Quería que se Sepa", "total", xAxis, series);
            } else {
                xAxis = {
                ...
                graf2(
                    "container",
                    "No Pidió Ayuda porque no Quería que se Sepa",
                    "total",
                    xAxis,
...
<template>
    <Head title="No Pidió Ayuda porque no Quería que se Sepa"></Head>
    <v-container>

...
const getInfoAnalisis = () => {
    axios
        .get(route("npdf_porfamilia.grafico"), {
        ...
        .then((response) => {
            ...
            if (formGrafico.value.filtro == "todos") {
                graf1("container", "Mujeres que no Presentaron Denuncia porque su Familia la convenció de no Hacerlo", "total", xAxis, series);
            } else {
                xAxis = {
                ...
                graf2(
                    "container",
                    "Mujeres que no Presentaron Denuncia porque su Familia la convenció de no Hacerlo",
                    "total",
                    xAxis,
...
<template>
    <Head title="Mujeres que no Presentaron Denuncia porque su Familia la convenció de no Hacerlo"></Head>
    <v-container>

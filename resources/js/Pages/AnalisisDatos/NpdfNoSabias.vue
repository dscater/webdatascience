...
const getInfoAnalisis = () => {
    axios
        .get(route("npdf_nosabia.grafico"), {
        ...
        .then((response) => {
            ...
            if (formGrafico.value.filtro == "todos") {
                graf1("container", "Mujeres que no Presentaron Denuncia porque no Sabía que se Podía Denunciar", "total", xAxis, series);
            } else {
                xAxis = {
                ...
                graf2(
                    "container",
                    "Mujeres que no Presentaron Denuncia porque no Sabía que se Podía Denunciar",
                    "total",
                    xAxis,
...
<template>
    <Head title="Mujeres que no Presentaron Denuncia porque no Sabía que se Podía Denunciar"></Head>
    <v-container>

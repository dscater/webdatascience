...
const getInfoAnalisis = () => {
    axios
        .get(route("npdf_sinimportancia.grafico"), {
        ...
        .then((response) => {
            ...
            if (formGrafico.value.filtro == "todos") {
                graf1("container", "Mujeres que no Presentaron Denuncia porque se Trató de un Hecho sin Importancia", "total", xAxis, series);
            } else {
                xAxis = {
                ...
                graf2(
                    "container",
                    "Mujeres que no Presentaron Denuncia porque se Trató de un Hecho sin Importancia",
                    "total",
                    xAxis,
...
<template>
    <Head title="Mujeres que no Presentaron Denuncia porque se Trató de un Hecho sin Importancia"></Head>
    <v-container>

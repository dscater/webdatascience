...
const getInfoAnalisis = () => {
    axios
        .get(route("no_ayuda_nosabia.grafico"), {
        ...
        .then((response) => {
            ...
            if (formGrafico.value.filtro == "todos") {
                graf1("container", "No Pidió Ayuda porque no Sabía que Podía Denunciar", "total", xAxis, series);
            } else {
                xAxis = {
                ...
                graf2(
                    "container",
                    "No Pidió Ayuda porque no Sabía que Podía Denunciar",
                    "total",
                    xAxis,
...
<template>
    <Head title="No Pidió Ayuda porque no Sabía que Podía Denunciar"></Head>
    <v-container>

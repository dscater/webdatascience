...
const getInfoAnalisis = () => {
    axios
        .get(route("no_ayuda_amenaza.grafico"), {
        ...
        .then((response) => {
            ...
            if (formGrafico.value.filtro == "todos") {
                graf1("container", "No Pidió Ayuda por Amenaza", "total", xAxis, series);
            } else {
                xAxis = {
...
<template>
    <Head title="No Pidió Ayuda por Amenaza"></Head>
    <v-container>

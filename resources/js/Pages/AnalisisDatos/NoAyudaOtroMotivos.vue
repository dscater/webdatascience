...
const getInfoAnalisis = () => {
    axios
        .get(route("no_ayuda_otromotivo.grafico"), {
        ...
        .then((response) => {
            ...
            if (formGrafico.value.filtro == "todos") {
                graf1("container", "No Pidió Ayuda por otro Motivo", "total", xAxis, series);
            } else {
                xAxis = {
                ...
                graf2(
                    "container",
                    "No Pidió Ayuda por otro Motivo",
                    "total",
                    xAxis,
...
<template>
    <Head title="No Pidió Ayuda por otro Motivo"></Head>
    <v-container>

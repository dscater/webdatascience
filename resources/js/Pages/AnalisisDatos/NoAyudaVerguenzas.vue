...
const getInfoAnalisis = () => {
    axios
        .get(route("no_ayuda_verguenza.grafico"), {
        ...
        .then((response) => {
            ...
            if (formGrafico.value.filtro == "todos") {
                graf1("container", "No Pidió Ayuda por Vergüenza", "total", xAxis, series);
            } else {
                xAxis = {
...
<template>
    <Head title="No Pidió Ayuda por Vergüenza"></Head>
    <v-container>

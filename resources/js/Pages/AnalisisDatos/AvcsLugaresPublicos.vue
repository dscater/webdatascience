...
const getInfoAnalisis = () => {
    vaciaGraficos();
    axios
        .get(route("avcs_lugares_publicos.grafico"), {
        ...
        .then((response) => {
            ...
            // graficar(
            //     "container",
            //     "Agresiones Verbales de Carácter Sexual en lugares Públicos",
            //     "",
            //     "total",
            //     xAxis,
...
<template>
    <Head title="Agresiones Verbales de Carácter Sexual en lugares Públicos"></Head>
    <v-container>

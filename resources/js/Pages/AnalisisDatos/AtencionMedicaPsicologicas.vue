...
const getInfoAnalisis = () => {
    axios
        .get(route("atencion_medica_psicologica.grafico"), {
        ...
        .then((response) => {
            ...
            if (formGrafico.value.filtro == "todos") {
                graf1("container", "Mujeres que recibieron Atención Médica o Psicológica por estos Hechos", "total", xAxis, series);
            } else {
                xAxis = {
                ...
                graf2(
                    "container",
                    "Mujeres que recibieron Atención Médica o Psicológica por estos Hechos",
                    "total",
                    xAxis,
...
<template>
    <Head title="Mujeres que recibieron Atención Médica o Psicológica por estos Hechos"></Head>
    <v-container>

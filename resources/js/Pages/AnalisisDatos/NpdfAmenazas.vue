...
const getInfoAnalisis = () => {
    axios
        .get(route("npdf_amenaza.grafico"), {
        ...
        .then((response) => {
            ...
            if (formGrafico.value.filtro == "todos") {
                graf1("container", "Mujeres que no Presentaron Denuncia por Amenaza", "total", xAxis, series);
            } else {
                xAxis = {
                ...
                graf2(
                    "container",
                    "Mujeres que no Presentaron Denuncia por Amenaza",
                    "total",
                    xAxis,
...
<template>
    <Head title="Mujeres que no Presentaron Denuncia por Amenaza"></Head>
    <v-container>

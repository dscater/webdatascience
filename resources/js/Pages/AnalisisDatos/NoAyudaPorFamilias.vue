...
const getInfoAnalisis = () => {
    axios
        .get(route("no_ayuda_porfamilia.grafico"), {
        ...
        .then((response) => {
            ...
            if (formGrafico.value.filtro == "todos") {
                graf1("container", "No Pidió Ayuda porque la Familia le Pidió no Hacerlo", "total", xAxis, series);
            } else {
                xAxis = {
                ...
                graf2(
                    "container",
                    "No Pidió Ayuda porque la Familia le Pidió no Hacerlo",
                    "total",
                    xAxis,
...
<template>
    <Head title="No Pidió Ayuda porque la Familia le Pidió no Hacerlo"></Head>
    <v-container>

...
const getInfoAnalisis = () => {
    axios
        .get(route("no_ayuda_miedo.grafico"), {
        ...
        .then((response) => {
            ...
            if (formGrafico.value.filtro == "todos") {
                graf1("container", "No Pidió Ayuda por Miedo", "total", xAxis, series);
            } else {
                xAxis = {
...
<template>
    <Head title="No Pidió Ayuda por Miedo"></Head>
    <v-container>

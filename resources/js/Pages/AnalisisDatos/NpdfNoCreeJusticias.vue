...
const getInfoAnalisis = () => {
    axios
        .get(route("npdf_nocreejusticia.grafico"), {
        ...
        .then((response) => {
            ...
            if (formGrafico.value.filtro == "todos") {
                graf1("container", "Mujeres que no Presentaron Denuncia porque No Cree en la Justicia", "total", xAxis, series);
            } else {
                xAxis = {
                ...
                graf2(
                    "container",
                    "Mujeres que no Presentaron Denuncia porque No Cree en la Justicia",
                    "total",
                    xAxis,
...
<template>
    <Head title="Mujeres que no Presentaron Denuncia porque No Cree en la Justicia"></Head>
    <v-container>
